...
const LEVEL_CONFIG = {
    'Campus Leader': { color: '#fbbf24', bg: 'linear-gradient(135deg, #92400e, #fbbf24)', next: 300 },
    'Highly Active': { color: '#10b981', bg: 'linear-gradient(135deg, #065f46, #34d399)', next: 200 },
    'Active': { color: '#3b82f6', bg: 'linear-gradient(135deg, #1e3a5f, #60a5fa)', next: 100 },
    'Beginner': { color: '#94a3b8', bg: 'linear-gradient(135deg, #1e293b, #64748b)', next: 40 },
};
                ...
                <Box sx={{ position: 'relative', zIndex: 1 }}>
                    <Box display="flex" alignItems="center" gap={2} mb={1}>
                        ...
                        <Box>
                            ...
                            <Chip label={d.engLevel} sx={{ bgcolor: 'rgba(255,255,255,0.2)', color: 'white', fontWeight: 900, fontSize: '0.78rem', height: 24 }} />
                        </Box>
                    </Box>
            ...
            <Grid container spacing={3} sx={{ mb: 4 }}>
                <Grid item xs={12} md={4}>
                    <Paper sx={{ p: 3, borderRadius: '20px', border: `2px solid ${lvl.color}40`, textAlign: 'center', height: '100%' }}>
                        ...
                        <Typography variant="caption" color="text.secondary" mt={1} display="block">
                            {d.engPct < 100 ? `${100 - d.engPct}% to next level` : 'Top level reached'}
                        </Typography>
                        ...
                        <Box sx={{ mt: 2.5, textAlign: 'left' }}>
                            ...
                            {[
                                { label: 'Registrations', pts: d.registrationPts, icon: 'RG' },
                                { label: 'Events Attended', pts: d.attendedPts, icon: 'AT' },
                                { label: 'Club Memberships', pts: d.membershipPts, icon: 'CM' },
                                { label: 'Certificates', pts: d.certificatePts, icon: 'CF' },
                                { label: 'Feedback Given', pts: d.feedbackPts, icon: 'FB' },
                            ].map((row) => (
                ...
                <Grid item xs={12} md={8}>
                    ...
                    <Paper sx={{ p: 2.5, borderRadius: '14px', border: '1px solid', borderColor: 'divider' }}>
                        <Typography variant="caption" fontWeight={800} color="text.secondary" textTransform="uppercase" mb={1.5} display="block">
                            Level Thresholds
                        </Typography>
                        {[
